...
export function DroppableAnchor({
  ...
  const fillColor = isOver ? '#22c55e' : isHighlighted ? '#3b82f6' : '#4b5563';
  const opacity = anchor.isOccupied ? 0 : isOver ? 0.8 : isHighlighted ? 0.6 : 0.3;
